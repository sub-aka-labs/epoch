        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-14 items-center justify-between">
            ...
            <div className="mr-3 flex items-center gap-3">
              ...
              {showLive && (
                <div className="hidden items-center gap-2 bg-emerald-100 px-2 py-1 sm:flex dark:bg-emerald-500/10">
                  <span className="relative flex h-2 w-2">
                    <span className="absolute inline-flex h-full w-full animate-ping bg-emerald-500 opacity-75 dark:bg-emerald-400" />
